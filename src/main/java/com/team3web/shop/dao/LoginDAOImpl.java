...
public class LoginDAOImpl implements LoginDAO {
	...
	@Override
    public void insertAutoLoginToken(Map<String, Object> autoLoginInfo) {
        sqlSession.insert("insertAutoLoginToken", autoLoginInfo);
    }

    @Override
    public Map<String, Object> findAutoLoginToken(String id) {
        return sqlSession.selectOne("findAutoLoginToken", id);
    }
    
    @Override
	public void deleteAutoLoginInfoById(String id) {
    	sqlSession.getMapper(LoginMapper.class).deleteAutoLoginInfoById(id);
	}
