...
public class UserDAOImpl implements UserDAO {
	...
	public void paid(Map<String, Object> map) {
    	sqlSession.getMapper(UserMapper.class).paid(map);
	}

	@Override
	public void rePaid(Map<String, Object> map) {
		sqlSession.getMapper(UserMapper.class).rePaid(map);
	}

	@Override
	public String paidCheck(String ID) {
		return sqlSession.getMapper(UserMapper.class).paidCheck(ID);
	}
