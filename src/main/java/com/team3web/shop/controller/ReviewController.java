...
public class ReviewController {
	...
	public void exUpload() {
     ...
     public String insertReview(@ModelAttribute ReviewVO review, @RequestParam("uploadFile") MultipartFile file, Model model) throws IOException {
         // 파일 저장 경로 설정 : 실제 서비스되는 위치(프로젝트 외부에 저장)
         String savedFileName = "";
         String externalUploadPath ="E:/jihyeon/imgUpload/";
         ...
         review.setRe_file(savedFileName);
