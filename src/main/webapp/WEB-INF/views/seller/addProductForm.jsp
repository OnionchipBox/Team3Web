       ...
       <form action="<%=request.getContextPath()%>/addProduct" method="post" enctype="multipart/form-data">
         ...
         <div class="form-group row">
            <label class="col-sm-2" >분류</label> <select id="categoryId"
               ...
               <option value="5">드레스</option>
               <option value="6">하의</option>
               <option value="7">스커트</option>
            </select>
            <div class="com-sm-3">
            </div>
         </div>
         ...
         <div class="form-group row">
            ...
            <div class="com-sm-5">
               <input type="radio" name="subCategory" value="0"> 혼용 <input
                  type="radio" name="subCategory" value="1"> 남성 <input
                  type="radio" name="subCategory" value="2"> 여성
            </div>
         </div>
         <div class="form-group row">
