         ...
         <!-- Repeat the below card structure for each product -->
           <c:forEach items="${products}" var="product">
            <div class="col-xl-3 col-lg-4 col-md-6 col-6 mb-2">
                ...
                <div class="card">
                    <img src="<%=request.getContextPath()%>/images/${product.productId}" class="card-img-top" alt="Product Image ${product.productId}">
                    <div class="card-body">
                        <p class="card-title mb-0" style="font-weight: bold;">${product.name}</p>
                        <p class="card-text mb-1"></p>
                        <p class="card-text mt-3" style="font-weight: bold;">${product.price}원</p>
